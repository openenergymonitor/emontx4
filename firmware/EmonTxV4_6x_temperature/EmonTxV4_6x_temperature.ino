...
#define MAX_TEMPS 6                                        // The maximum number of temperature sensors
...
void loop()             
{
  ...
  if (EmonLibCM_Ready())   
  {
    ...
    if (EEProm.json_enabled) {
      ...
      if (emontx.T4!=30000) { Serial.print(F(",\"T4\":")); Serial.print(emontx.T4*0.01); }
      if (emontx.T5!=30000) { Serial.print(F(",\"T5\":")); Serial.print(emontx.T5*0.01); }
      if (emontx.T6!=30000) { Serial.print(F(",\"T6\":")); Serial.print(emontx.T6*0.01); }
